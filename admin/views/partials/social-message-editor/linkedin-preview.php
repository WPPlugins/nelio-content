<?php
/**
 * This partial previews a social message in LinkedIn.
 *
...
?>
<script type="text/template" id="_nc-linkedin-preview">

	<div class="nc-linkedin-preview">
		...
		<div class="nc-profile-and-date">
			...
			<div class="nc-name-and-date">
				...
				<div class="nc-display-name"><%= _.escape( profile.displayName ) %></div>
			...
			<% if ( sharedLink.status === 'ready' ) { %>
				...
				<div class="nc-post">
					...
					<div class="nc-content">
						...
						<p class="nc-title"><%= _.escape( sharedLink.title ) %></p>

						<p class="nc-excerpt">
							<a class="nc-link"><%= _.escape( sharedLink.domain ) %></a>
							<% if ( sharedLink.excerpt.length > 0 ) { %>
								• <%= _.escape( sharedLink.excerpt ) %>
							<% } %>
						</p><!-- .nc-c-excerpt -->
	...
	</div><!-- .nc-linkedin-preview -->

</script><!-- #_nc-linkedin-preview -->
